...
public class DirectorFormBean implements Serializable {
	...
	private ListDataModel<Director> directors = new ListDataModel<Director>();
	...
	public ListDataModel<Director> getAllDirectors() {
		directors.setWrappedData(dbDirector.getAllDirectors());
		return directors;
	}

	// Actions
	public String addDirector() {
		dbDirector.addDirector(director);
		return "showDirectors";
		//return null;
	}

	public String deleteDirector() {
		Director directorToDelete = directors.getRowData();
		dbDirector.deleteDirector(dbDirector.getIdDirectorBySurname(directorToDelete.getSurname()));
		return null;
	}
